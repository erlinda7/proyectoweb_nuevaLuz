<template>
  <div class="container">
    ...
    <div class="loginadmin">
      <b-form @submit.stop.prevent @submit="onSubmit" @reset="onReset" v-if="show">
        <b-form-group id="input-group-2" label="Usuario:" label-for="input-2">
          <b-form-input id="input-2" v-model="form.usuario" required placeholder="Ingrese Usuario"></b-form-input>
        </b-form-group>
        <br>
        <label for="text-password" >Contraseña</label>
        <b-input type="password" id="text-password" aria-describedby="password-help-block" placeholder="Ingrese Contraseña" v-model="form.contrasenia" required>
        </b-input>
        <br>
    ...
    <div class="row">
      <div class="col-sm">
        <router-link to="/AdministrarMiembro"><button class="btn btn-primary">Ir al formulario Miembro</button></router-link>
      </div>
      <div class="col-sm">
