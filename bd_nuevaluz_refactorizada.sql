...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-02-2020 a las 00:40:24
...
(3, '/images/anciano1.png', 5),
(4, '/images/anciano2.png', 6),
(5, '/images/anciano3.png', 7),
(6, '/images/anciano4.png', 8),
(7, '/images/anciano5.png', 9);
...
INSERT INTO `miembro` (`id_miembro`, `nombre`, `apellido_paterno`, `apellido_materno`, `telefono`, `estado_civil`, `fecha_nac`, `fecha_conversion`, `iglesia_conversion`, `fecha_bautizo`, `iglesia_bautizo`, `nom_completo_pastor_bautizo`) VALUES
(1, 'Edgar', 'Jimenez ', 'Antezana', 78323149, 'casado', '1997-06-16', '1997-07-11', 'Eben Ezer', '0000-00-00', 'Libres', 'Lideres'),
(2, 'Feliciano', 'Mendoza ', 'Fabricano', 70396979, 'casado', '1984-04-12', '1994-06-12', 'Nueva Jerusalen UCE', '1996-09-30', 'Nueva Jerusalen UCE', 'Juan Cuellar'),
(5, 'Patricio', 'Quispe ', 'Colque', 68516412, 'casado', '1981-08-24', NULL, 'Bautista', '0000-00-00', 'Bautista Kumara', 'Agustin Cuti'),
...
(33, 'Martha', 'Mamani', 'Mamani', 63958774, 'soltera', '0000-05-15', '0000-12-25', 'Nueva Canaan', '0000-00-00', 'Nueva Canaan', ''),
(34, 'Gladys', 'Mamani', 'Lopez', 63914553, 'soltero', '1998-06-21', '2011-09-00', 'Nueva Luz', '2013-12-25', 'Nueva Luz', 'Marcelino Camacho'),
...
(37, 'Oscar', 'Berrios', 'Luna', 68322275, 'casado', '1992-01-21', '2004-01-25', 'Nueva Luz', '2012-12-25', 'Nueva Luz', 'Marcelino Camacho\r\n'),
(38, 'Maria', 'Aguilar', 'Fernandez', 68597691, 'casado', '0000-06-22', '0000-09-23', 'Nueva Canaan', '0000-09-23', 'Yoraq Kaqa', 'Octavio Condori');
...
--
ALTER TABLE `cargo_lider`
  MODIFY `id_cargo_lider` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `gestion_cargo`
  MODIFY `id_gestion_cargo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `miembro`
  MODIFY `id_miembro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
